...
def evaluation3class(prediction,y ):
    F1, F2 , F3 = f1_score(prediction.cpu(), y.cpu(), labels=[0,1,2], average=None, zero_division=1)
    return 0, 0,0,0,F1, 0,0,0,F2, 0,0,0,F3, 0,0,0,0
